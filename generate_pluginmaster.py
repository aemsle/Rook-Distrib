...
DOWNLOAD_URL = 'https://github.com/aemsle/Rook-Distrib/raw/{branch}/plugins/{plugin_name}/latest.zip'
ICON_URL = 'https://raw.githubusercontent.com/aemsle/Rook-Distrib/{branch}/icons/{plugin_name}.png'
